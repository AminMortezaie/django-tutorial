...
# address = "t1cXkyYUZ3k9AC1wxmEjyz5HgmBwMPeTLHA"  # the Litecoin address you want to get transactions for
...
def get_transactions_zcash(wallet_address):
    responses = []

    # Construct the API URL
    api_url = f"https://zec.getblock.io/{getblock_api}/mainnet/blockbook/api/v2/address/{wallet_address}"
...
def get_tx_data(tx_hash):
    api_url_tx = f"https://zec.getblock.io/{getblock_api}/mainnet/blockbook/api/tx/{tx_hash}"
...
# res = get_transactions_zcash(wallet_address=address)
# print(res)
