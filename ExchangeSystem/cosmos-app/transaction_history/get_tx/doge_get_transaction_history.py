...
# address = "DDeieDQSVq2s139MqsEQ88RFpUkVo7duoc"  # the Litecoin address you want to get transactions for
...
def get_transactions_doge(wallet_address):
    responses = []

    # Construct the API URL
    api_url = f"https://doge.getblock.io/{getblock_api}/mainnet/blockbook/api/v2/address/{wallet_address}"
...
def get_tx_data(tx_hash):
    api_url_tx = f"https://doge.getblock.io/{getblock_api}/mainnet/blockbook/api/tx/{tx_hash}"
...
# res = get_transactions_doge(wallet_address=address)
# print(res)
