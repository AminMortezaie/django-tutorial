...
const runAll = (transaction) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const faucetTx = (yield client.getTx("A1D7733898BFC29DB13672DF03C065EA5F2DF3ABC3C06E427FB114CB05E7D901"));
    const decodedTx = tx_1.Tx.decode(faucetTx.tx);
    const sendMessage = tx_2.MsgSend.decode(decodedTx.body.messages[0].value);
    ...
    const result = yield signingClient.sendTokens(fromAddress, toAddress, [{ denom: "uatom", amount: amount }], {
